...
function App() {
  ...
  const [counters, setCounters] = useState({ scanned: 10, pending: 0, uploaded: 10 })
  ...
  return (
    <>
      ...
      <div className="floating-languages-container" ref={floatingLanguagesRef}></div>
      ...
      <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
        ...
        <ul className="nav-links">
          ...
          <li><a href="#translate" onClick={(e) => handleAnchorClick(e, '#translate')}>Translate</a></li>
          <li><a href="#scan" onClick={(e) => handleAnchorClick(e, '#scan')}>Scan</a></li>
          <li><a href="#automation" onClick={(e) => handleAnchorClick(e, '#automation')}>Automation</a></li>
          <li><a href="#download" onClick={(e) => handleAnchorClick(e, '#download')} className="nav-cta">Get the App</a></li>
        </ul>
        <button 
      ...
      <div className={`mobile-menu ${mobileMenuOpen ? 'active' : ''}`}>
        <ul>
          ...
          <li><a href="#scan" onClick={(e) => handleAnchorClick(e, '#scan')}>Scan</a></li>
          <li><a href="#automation" onClick={(e) => handleAnchorClick(e, '#automation')}>Automation</a></li>
          <li><a href="#download" onClick={(e) => handleAnchorClick(e, '#download')}>Get the App</a></li>
        </ul>
      </div>
        ...
        <div className="hero-content">
          <div className="hero-text">
            <div className="badge-container">
              <span className="badge badge-purple">Made in India</span>
              <span className="badge badge-gold">50+ Languages</span>
            </div>
            <h1 className="hero-title">
              <span className="title-line">Scan Anything.</span>
              <span className="title-line highlight">Understand Everything.</span>
            </h1>
            <p className="hero-subtitle">
              Business cards, documents, and signs—translated and organized in seconds. 
              AI-powered OCR with auto-export to Excel, WhatsApp, Email & Telegram.
            </p>
            <div className="hero-stats">
              <div className="stat-item">
                <span className="stat-number">99</span>
                <span className="stat-label">Free Scans</span>
              </div>
              <div className="stat-item">
              ...
              <div className="stat-item">
                ...
                <span className="stat-label">Scan Modes</span>
              </div>
            </div>
            <div className="hero-ctas">
              <a href="#download" onClick={(e) => handleAnchorClick(e, '#download')} className="btn btn-primary">
                <FaMobile className="btn-icon" />
                Get the App
              </a>
              <a href="#features" onClick={(e) => handleAnchorClick(e, '#features')} className="btn btn-secondary">See How It Works</a>
            </div>
          </div>
          <div className="hero-visual">
            <div className="phone-mockup">
              <div className="phone-screen">
                <div className="app-header">
                  <span className="app-title">Visitor Card Scan</span>
                  <div className="app-stats">
                    <div className="app-stat">
                      <span className="app-stat-number">{counters.scanned}</span>
                      <span className="app-stat-label">Scanned</span>
                    </div>
                    <div className="app-stat">
                      <span className="app-stat-number">{counters.pending}</span>
                      <span className="app-stat-label">Pending</span>
                    </div>
                    <div className="app-stat">
                      <span className="app-stat-number">{counters.uploaded}</span>
                      <span className="app-stat-label">Uploaded</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="app-scan-area">
                  ...
                  <p className="scan-text">Ready to Scan Business Cards</p>
                  <p className="scan-subtext">Position card in frame and capture</p>
            ...
            <div className="floating-card card-1">
              ...
              <span className="floating-card-text">Auto-detect Language</span>
            </div>
            <div className="floating-card card-2">
              <FaSync className="floating-card-icon" />
              <span className="floating-card-text">Real-time Sync</span>
            </div>
            <div className="floating-card card-3">
              <FaRobot className="floating-card-icon" />
              <span className="floating-card-text">AI Powered</span>
            </div>
          </div>
        </div>
      ...
      <section className="features" id="features">
        ...
        <div className="features-grid">
          <div className="feature-card feature-card-large">
            ...
            <h3 className="feature-title">Scan Cards, Docs & Signs</h3>
            <p className="feature-desc">
              OCR that works on curved cards, glossy paper, and handwritten notes. 
              Capture business cards, A4 documents, and shop boards with precision.
            </p>
          ...
          <div className="feature-card feature-card-top">
            ...
            <h3 className="feature-title">Translate Instantly</h3>
            <p className="feature-desc">
              50+ languages, offline-ready. From Hindi to Tamil, Bengali to Gujarati—
              understand every word in your language.
            </p>
          ...
          <div className="feature-card feature-card-bottom">
            ...
            <p className="feature-desc">
              Sheets, email, WhatsApp, Telegram—automated. Your scanned data goes 
      ...
      <section className="translate-section" id="translate">
        <div className="translate-content">
          <div className="translate-text">
            <span className="section-badge">INSTANT TRANSLATE</span>
            <h2 className="section-title">Read Any Sign in Seconds.</h2>
            <p className="section-desc">
              Point your camera at menus, boards, and labels—get a clean translation 
              without retyping. Perfect for exhibitions, networking events, and travel.
            </p>
            <ul className="feature-list">
              ...
              <li>
                ...
                <span>Works at an angle - tilted text detection</span>
              </li>
              <li>
                <FaMoon className="list-icon" />
                <span>Works in low light - night mode OCR</span>
              </li>
            </ul>
          </div>
          <div className="translate-visual">
            <div className="translate-card">
              <div className="original-text">
                ...
                <p className="text-content">व्यापार कार्ड स्कैनर</p>
              </div>
              <div className="arrow-down"><FaArrowDown /></div>
              <div className="translated-text">
                <span className="text-label">Translated</span>
                <p className="text-content">Business Card Scanner</p>
              </div>
      ...
      <section className="scan-section" id="scan">
        <h2 className="section-title-center">Scan Anything.</h2>
        <div className="scan-grid">
          <div className="scan-card">
            ...
            <div className="scan-card-content">
              ...
              <p>Scan A4 documents, contracts, and forms with automatic page detection.</p>
            </div>
          </div>
          <div className="scan-card">
            <div className="scan-card-image">
              <div className="card-mockup">
                <div className="business-card">
                  ...
                  <div className="card-info">
                    <div className="card-name">VoltAir Tech</div>
                    <div className="card-company">Kauntech Partner</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="scan-card-content">
              ...
              <p>Extract contact info instantly from visiting cards and ID documents.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="automation-section" id="automation">
        ...
        <h2 className="section-title-center">Scan → Detect → Translate → Send</h2>
        <div className="automation-flow">
          <div className="flow-step">
            <div className="step-number">1</div>
            <div className="step-icon"><FaCamera /></div>
            <h3 className="step-title">Scan</h3>
            <p className="step-desc">Point and capture any document or card.</p>
          </div>
          ...
          <div className="flow-step">
            ...
            <p className="step-desc">OCR reads text instantly with AI precision.</p>
          </div>
          <div className="flow-arrow">→</div>
          <div className="flow-step">
            ...
            <p className="step-desc">Get it in your preferred language.</p>
          </div>
          <div className="flow-arrow">→</div>
          <div className="flow-step">
            <div className="step-number">4</div>
            <div className="step-icon"><FaFileExport /></div>
            <h3 className="step-title">Send</h3>
            <p className="step-desc">To Sheets, email, WhatsApp, or Telegram.</p>
          </div>
        </div>
        <div className="automation-features">
          <div className="auto-feature">
            <span className="auto-icon"><FaBolt /></span>
            <span className="auto-text">Lightning Fast</span>
          </div>
          <div className="auto-feature">
            <span className="auto-icon"><FaLock /></span>
            <span className="auto-text">Secure & Private</span>
          </div>
          <div className="auto-feature">
            <span className="auto-icon"><FaRobot /></span>
      ...
      <section className="download-section" id="download">
        <div className="download-content">
          <div className="download-text">
            <h2 className="download-title">Get Kauntech Free.</h2>
            <p className="download-subtitle">
              99 scans per account. Sync to Google Sheets & Telegram. 
            ...
            <ul className="download-features">
              ...
              <li>
                <span className="check-icon">✓</span>
                <span>Auto-export to Sheets, Email, WhatsApp, Telegram</span>
              </li>
              <li>
                <span className="check-icon">✓</span>
            ...
            <div className="download-buttons">
              ...
              <a href="#" className="store-btn play-store">
                <span className="store-icon"><FaAndroid /></span>
                <div className="store-text">
          ...
          <div className="download-visual">
            ...
            <div className="cta-card premium">
              <div className="cta-card-header">
                <span className="cta-badge premium-badge">PRO</span>
                <span className="cta-plan">Automation AI</span>
              </div>
              <div className="cta-card-price">
              ...
              <button className="cta-btn premium-btn">Upgrade Now</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="footer">
        <div className="footer-content">
          <div className="footer-brand">
            ...
            <p className="footer-tagline">Scan anything. Understand everything.</p>
        ...
        <div className="footer-bottom">
          <p>&copy; 2026 Kauntech. All rights reserved. Made with <FaHeart /> in India.</p>
        </div>
      </footer>
    </>
  )
